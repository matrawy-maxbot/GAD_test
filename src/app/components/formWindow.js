...
const FormWindow = () => {
    ...
    const closeFormWindow = (e) => {
        formWindowRef.current?.classList.remove("active");
    };
        ...
        <div ref={formWindowRef} className="form-window-parent">
            <div className="form-window-container">
                <div className="header">
                    ...
                    <div className="close" onClick={closeFormWindow}>
                ...
                <div className="content">
                    <div className="left-side">
                        ...
                        <h2 className="title">Start Your Business Registration</h2>
                        <p className="description">Please fill out the form below with your personal details to get started</p>
                    </div>
                    <div className="right-side">
                        ...
                        <form id="add-request-form">
                            <div className="field">
                                ...
                                <input type="text" id="companyName" name="fname" defaultValue="" placeholder="Company name or your personal name"/>
                            </div>
                            <br/>
                            <div className="field">
                                ...
                                <div className="sub-field">
                                    <input type="text" id="phone1" name="lname" defaultValue="" placeholder="Phone number"/>
                                    <div className="check-whatsapp-container">
                                        <input type="checkbox" id="whatsappNumber1" name="fav_language" defaultValue=""/>
                                ...
                                <div className="sub-field">
                                    <input type="text" id="phone2" name="lname" defaultValue="" placeholder="Alternate Phone Number (Optional)"/>
                                    <div className="check-whatsapp-container">
                                        <input type="checkbox" id="whatsappNumber2" name="fav_language" defaultValue=""/>
                                        <div className="background">
                                            <svg viewBox="0 0 418.135 418.135">
                                                <g>
                                                    <path fill="inherit" d="M198.929.242C88.5 5.5 1.356 97.466 1.691 208.02c.102 33.672 8.231 65.454 22.571 93.536L2.245 408.429c-1.191 5.781 4.023 10.843 9.766 9.483l104.723-24.811c26.905 13.402 57.125 21.143 89.108 21.631 112.869 1.724 206.982-87.897 210.5-200.724C420.113 93.065 320.295-5.538 198.929.242zm124.957 321.955c-30.669 30.669-71.446 47.559-114.818 47.559-25.396 0-49.71-5.698-72.269-16.935l-14.584-7.265-64.206 15.212 13.515-65.607-7.185-14.07c-11.711-22.935-17.649-47.736-17.649-73.713 0-43.373 16.89-84.149 47.559-114.819 30.395-30.395 71.837-47.56 114.822-47.56 43.372.001 84.147 16.891 114.816 47.559 30.669 30.669 47.559 71.445 47.56 114.817-.001 42.986-17.166 84.428-47.561 114.822z"></path>
                            ...
                            <div className="field">
                                ...
                                <span className="warnMessage">This field is required *</span>
                                <input type="text" id="whatsappNumber" name="lname" defaultValue="" placeholder="Whatsapp phone number"/>
                            </div>
                            <br/>
                            <div className="field">
                                ...
                                <div className="checkbox-container">
                                    <div className="check-input-container">
                                        <input type="checkbox" id="designBusinessRequired" name="fav_language" defaultValue="design"/>
                                        <div className="background">
                                    ...
                                    <div className="check-input-container">
                                        <input type="checkbox" id="programmingBusinessRequired" name="fav_language" defaultValue="programming"/>
                                        <div className="background">
                                            <div className="check-mark">
                                                <svg viewBox="0 0 511.985 511.985"><path d="M500.088 83.681c-15.841-15.862-41.564-15.852-57.426 0L184.205 342.148 69.332 227.276c-15.862-15.862-41.574-15.862-57.436 0-15.862 15.862-15.862 41.574 0 57.436l143.585 143.585c7.926 7.926 18.319 11.899 28.713 11.899 10.394 0 20.797-3.963 28.723-11.899l287.171-287.181c15.862-15.851 15.862-41.574 0-57.435z" fill="inherit"></path></svg>
                                            </div>
                                    ...
                                    <div className="check-input-container">
                                        <input type="checkbox" id="printingBusinessRequired" name="fav_language" defaultValue="printing"/>
                                        <div className="background">
                                            <div className="check-mark">
                                                <svg viewBox="0 0 511.985 511.985"><path d="M500.088 83.681c-15.841-15.862-41.564-15.852-57.426 0L184.205 342.148 69.332 227.276c-15.862-15.862-41.574-15.862-57.436 0-15.862 15.862-15.862 41.574 0 57.436l143.585 143.585c7.926 7.926 18.319 11.899 28.713 11.899 10.394 0 20.797-3.963 28.723-11.899l287.171-287.181c15.862-15.851 15.862-41.574 0-57.435z" fill="inherit"></path></svg>
                                            </div>
                            ...
                            <div className="field">
                                ...
                                <div className="radio-container">
                                    <div className="radio-input-container">
                                        <input type="radio" id="personalCompanySize" name="fav_language" defaultValue="personal"/>
                                        <div className="background">
                                    ...
                                    <div className="radio-input-container">
                                        <input type="radio" id="smallCompanySize" name="fav_language" defaultValue="small"/>
                                        <div className="background">
                                            <div className="radio-mark"></div>
                                        </div>
                                    ...
                                    <div className="radio-input-container">
                                        <input type="radio" id="mediumCompanySize" name="fav_language" defaultValue="medium"/>
                                        <div className="background">
                                            <div className="radio-mark"></div>
                                        </div>
                                    ...
                                    <div className="radio-input-container">
                                        <input type="radio" id="largeCompanySize" name="fav_language" defaultValue="large"/>
                                        <div className="background">
                                            <div className="radio-mark"></div>
                                        </div>
                                    ...
                                    <div className="radio-input-container">
                                        <input type="radio" id="enterpriseCompanySize" name="fav_language" defaultValue="enterprise"/>
                                        <div className="background">
                                            <div className="radio-mark"></div>
                                        </div>
