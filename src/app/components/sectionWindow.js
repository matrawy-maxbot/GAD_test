    ...
    <div className="section-window-parent">
        <div className="section-window-container">
            <div className="header">
                ...
                <div className="title design-title">Creative Design Solutions</div>
                <div className="title programming-title">Innovative Programming Solutions</div>
                <div className="title printing-title">Exceptional Printing Services</div>
            ...
            <div className="content-container">
                <div className="content">
                    <h2 className="design-content">
                        We specialize in crafting unique and impactful designs that enhance your brand&apos;s identity. Whether it&apos;s{" "}
                        <span>logo</span> design, <span>branding</span>, or user interface{" "}
                        <span>(UI)</span> and user experience <span>(UX)</span> design, our
                        team delivers innovative solutions tailored to your needs
                    </h2>
                    <h2 className="programming-content">
                        Our programming services bring your ideas to life through cutting-edge
                        technology and efficient code...
                    </h2>
                    <h2 className="printing-content">
                        We offer high-quality printing services that bring your concepts to
